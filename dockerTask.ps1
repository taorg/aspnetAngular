...
.PARAMETER Clean
Removes the image aspnetangular and kills all containers based on that image.
...
Build a Docker image named aspnetangular
#>
...
$imageName="aspnetangular"
$projectName="aspnetangular"
$serviceName="aspnetangular"
